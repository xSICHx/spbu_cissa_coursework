...
data <- list(
  Метод = c("SSA","SSA EOSSA","Fourier", "CiSSA", "CiSSA extended"),
  sin_err = list(list(), list(), list(), list(), list()),
  cos_err = list(list(), list(), list(), list(), list())
)
...
for (i in 1:100){
  ...
  data$sin_err[[1]][[i]] <-
    min(mse(y2[1:(n-1)], r_ssa$F2), mse(y2[1:(n-1)], r_ssa$F1))
...
data <- list(
  ...
  sin_err = list(list(), list(), list(), list(), list()),
  cos_err = list(list(), list(), list(), list(), list()),
  exp_err = list(list(), list(), list(), list(), list())
)
